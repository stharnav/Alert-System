<script>
        function setMessage() {
            ...
            if (alertType === 'earthquake') {
                ...
                messageTitleElement.value = 'भूकम्प चेतावनी! Earthquake Alert!';
                ...
                messageTitleElement.value = 'बाढी चेतावनी! Flood Alert!';
                ...
                messageTitleElement.value = 'पहिरो चेतावनी! Landslide Alert!';
                earthquakeScaleElement.value = null;
                earthquakeScaleCol.style.display = 'none';
            }else{
                 messageBodyElement.value = '';
                messageTitleElement.value = '';
            }
        }
